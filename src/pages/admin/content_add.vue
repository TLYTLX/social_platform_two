...
<script type="es6">
    ...
    export default {
        data() {
            return {
                form: {
                    title: '',
                    selected: '',
                    categories: ['表白墙','相约华工','匿名论坛','校园热点事件','二手交易','合租信息共享'],
                    desc: '',
                    content: ''
                },
                rules: {
        ...
        created() {
//            this.$http.get('http://localhost:8081/admin/content/add').then(response => {
...
//            })
        ...
        methods: {
            onSubmit() {
                ...
                this.$http.post('http://localhost:8081/admin/content/add', {
